About sqlobject-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sqlobject-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/sqlobject/sqlobject
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4335&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sqlobject-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sqlobject` can be installed with `conda`:
...
```
mamba install sqlobject
```

It is possible to list all of the versions of `sqlobject` available on your platform with `conda`:
...
```
mamba search sqlobject --channel conda-forge
```
...
mamba repoquery search sqlobject --channel conda-forge

# List packages depending on `sqlobject`:
mamba repoquery whoneeds sqlobject --channel conda-forge

# List dependencies of `sqlobject`:
mamba repoquery depends sqlobject --channel conda-forge
```
